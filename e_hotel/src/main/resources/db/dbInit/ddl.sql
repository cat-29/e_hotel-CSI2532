...
nbr_hotel INTEGER CHECK(nbr_hotel > 0),
numero INTEGER NOT NULL check(numero>0),
rue VARCHAR NOT NULL check(length(rue)>2),
...
id_superviseur CHAR(9),
id_employe CHAR(9) CHECK (id_superviseur <> id_employe),
