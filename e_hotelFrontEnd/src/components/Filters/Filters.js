                ...
                <div id='pricipauxFiltres' className=' text-center gap-5 ms-1 d-md-flex flex-wrap'>
                    ...
                    <div id='priceRangerMin'>
                        ...
                        <div className="input-group mb-3">
                            ...
                            <InputMask id='priceMin' className="form-control border" mask='999,999,99' placeholder="XXXXXXXX" maskChar={''} value={filters.prixMin} onChange={handleInputChange} name="prixMin"/>
                    ...
                    <div id='priceRangeMax'>
                        ...
                        <div className="input-group mb-3">
                            <span className="input-group-text">$</span>
                            {/* <input type="text" className="form-control" onChange={handleInputChange} aria-label="Amount (to the nearest dollar)"/> */}
                            <InputMask id='priceMax' className="form-control border" mask='999,999,99' placeholder="XXXXXXXX" maskChar={''} value={filters.prixMax} onChange={handleInputChange} name="prixMax"/>
                            <span className="input-group-text">.00</span>
                        </div>
                    </div>
                </div>
